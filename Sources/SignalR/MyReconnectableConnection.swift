...
internal class ReconnectableConnection: Connection {
    ...
    private var wrappedDelegate: MyConnectionDelegate?
    ...
    weak var delegate: MyConnectionDelegate?
    ...
    private class ReconnectableConnectionDelegate: MyConnectionDelegate {
